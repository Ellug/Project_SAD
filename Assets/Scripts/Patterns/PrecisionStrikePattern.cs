...
public class PrecisionStrikePattern : PatternBase
{
    ...
    [Tooltip("경고 파티클 추적 시간")][SerializeField] float _ExpolsionTime;
    ...
    private IEnumerator Explosion()
    {
        ...
        _Explosion = Instantiate(_ExplosionParticle);
        _Explosion.transform.position = _Warnning.transform.position;
        _Explosion.Play();
        ...
        float duration = _Explosion.main.duration;

        Destroy(_Explosion.gameObject, duration);
    }
